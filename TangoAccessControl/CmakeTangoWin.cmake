...
set(TANGO_DYN_LIBS "$ENV{TANGO_ROOT}/lib/omniORB4_rt.lib;$ENV{TANGO_ROOT}/lib/tango.lib;$ENV{TANGO_ROOT}/lib/omniDynamic4_rt.lib;$ENV{TANGO_ROOT}/lib/COS4_rt.lib;$ENV{TANGO_ROOT}/lib/omnithread_rt.lib;$ENV{TANGO_ROOT}/lib/msvcstub.lib;$ENV{TANGO_ROOT}/lib/pthreadVC2.lib")                                            
set(WIN_LIBS ws2_32 mswsock advapi32 comctl32 odbc32 crypt32)
if(MSVC90)
